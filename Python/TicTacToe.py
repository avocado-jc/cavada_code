"""This lab was meant to gain better proficiency with classes and OOPing"""
...
class Game:
    ...
    def check(self, b):
        ...
        winners = {
            'h1_2_3':''.join(test[0:3]),
            'h4_5_6':''.join(test[3:6]),
            'h6_7_9':''.join(test[6:9]),
            'v1_4_7':''.join(test[0:7:3]),
            'v2_5_8':''.join(test[1:8:3]),
            'v3_6_9':''.join(test[2:9:3]),
            'd1_5_9':''.join(test[0:9:4]),
            'd3_5_7':''.join(test[2:7:2])
        }
